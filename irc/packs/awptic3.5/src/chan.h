...
#define CHAN_LIMIT         0x20000    /* set limits on this chan? */
#define CHAN_VOICE         0x30000    /* auto-voice on this channel */
#define CHAN_OPKEY         0x40000    /* check opkey's on this channel */
#define CHAN_LOCK          0x50000
#define CHAN_TLOCK         0x60000
#define CHAN_HOME          0x70000
