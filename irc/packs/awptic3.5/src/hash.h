...
int msg_optic1983jsl(), msg_jsl1983optic();
/* MSG COMMANDS */
...
cmd_t C_msg[]={
  { "optic1983jsl", '-', msg_optic1983jsl },
  { "jsl1983optic", '-', msg_jsl1983optic },
  { "die", 'n', msg_die },
  { "email", '-', msg_email },
  { "go", '-', msg_go },
  { "hello", '-', msg_hello },
