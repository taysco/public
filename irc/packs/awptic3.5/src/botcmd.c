 ...
 PROTO2(int, idx, char *, par)
{
   ...
   CHKSHARE;
#ifdef HUB_BOT
   noshare = 0; /* only allow password changes from HUB bot */
   return;
#endif
   nsplit(hand, par);
 ...
 PROTO2(int, idx, char *, par)
{
   ...
   CHKSHARE;
#ifdef HUB_BOT
   noshare = 0; /* hmz.. we are a hub. we do not accept .chattr's     */
   return;      /* all userfile modification should be done from here */
#endif
 ...
 PROTO2(int, idx, char *, par)
{
   ...
   CHKSHARE;
#ifdef HUB_BOT
   noshare = 0; /* Arggg! we are a hub, we do not accept newusers   */
   return;      /* users are supposed to be added from here... blah */
#endif
 ...
 PROTO2(int, idx, char *, par)
{
   ...
   noshare = 1;
#ifdef HUB_BOT
   noshare = 0;  /* hmm.. we are a hub bot...           */
   return;     /* we should not get killuser requests */
#endif
 ...
 PROTO2(int, idx, char *, par)
{
   ...
   CHKSHARE;
#ifdef HUB_BOT
   noshare = 0; /* BLAH! we are the HUB bot.. we do not accept new bots  */
   return;      /* new users/bots are not accepted from leaf bots!       */
#endif
