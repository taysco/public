...
void failed_link PROTO((int,int));
...
int host_on_chan PROTO((struct chanset_t *, char *));
...
unsigned long own_htonl PROTO((IP));
IP getmyip();
...
int readtclprog PROTO((char *, char*));
