...
#define NO_SERVERLIST_UPDATE

   /* remove any bogus bans (i.e. which contain special chars like ^C)*/
#undef KILL_BOGUS_BANS
...
struct chat_info {
  ...
  int strip_flags;          /* what codes to strip (a,b,c,r,u) */
