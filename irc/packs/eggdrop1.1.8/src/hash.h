...
int cmd_pls_ban(), cmd_pls_bot(), cmd_chat(), cmd_pls_host(), cmd_pls_ignore(),
  ...
  cmd_show_telnethost(), cmd_pls_telnethost(), cmd_mns_telnethost(),
#ifdef ENABLE_SIMUL
  cmd_simul(),
#endif
...
cmd_t C_dcc[]={
  ...
  { "+telnethost", 'n', cmd_pls_telnethost },
  { "+user", 'm', cmd_pls_user },
  { "-ban", 'O', cmd_mns_ban },
  { "-bot", 'B', cmd_mns_user },
  ...
  { "-telnethost", 'n', cmd_mns_telnethost },
  { "-user", 'm', cmd_mns_user },
#ifndef NO_IRC
  { "act", 'O', cmd_act },
#endif
  ...
  { "set", 'n', cmd_set },
#endif
  { "telnethosts", 'n', cmd_show_telnethost },
#ifdef ENABLE_SIMUL
  { "simul", 'n', cmd_simul },
#endif
  { "status", 'M', cmd_status },
